...
from src.client.utils.fs_utils import get_image_names
from src.client.utils.windows_utils import get_window_info, careful_capture_window, capture_screen_region, \
    write_windows_list
